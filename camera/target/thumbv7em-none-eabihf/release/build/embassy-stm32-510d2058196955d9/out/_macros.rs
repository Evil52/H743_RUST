...
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((HSEM,hsem,HSEM,GLOBAL,HSEM1));
        ...
        __foreach_interrupt_inner!((SAI3,sai,SAI,A,SAI3));
        __foreach_interrupt_inner!((SAI3,sai,SAI,B,SAI3));
...
macro_rules! foreach_peripheral {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_peripheral_inner!((dlyb,DLYB_QUADSPI));
        __foreach_peripheral_inner!((dlyb,DLYB_SDMMC1));
        __foreach_peripheral_inner!((dlyb,DLYB_SDMMC2));
        ...
        __foreach_peripheral_inner!((mdma,MDMA));
